  ...
  reducers: {
    ...
    throwInitiative: (state) => {
      ...
      const updates = cards.map(({ id, initiativeBonus }) => ({
        id,
        changes: { initiative: rollDice(20) + initiativeBonus },
      }));
    ...
    builder
      .addCase(creatureActions.addCreature, (state, { payload }) => {
        ...
        cardsAdapter.updateOne(state, {
          id: payload.enemyId,
          changes: {
            creaturesIds: newCreaturesIds,
            lastCreatureIndex: enemy.lastCreatureIndex + 1,
          },
        });
      })
      .addCase(creatureActions.delCreature, (state, { payload }) => {
        ...
        cardsAdapter.updateOne(state, {
          id: payload.enemyId,
          changes: { creaturesIds: newCreaturesIds },
        });
      })
      .addCase(abilityActions.addAbility, (state, { payload }) => {
        ...
        cardsAdapter.updateOne(state, {
          id: payload.enemyId,
          changes: { abilitiesIds: newAbilitiesIds },
        });
      })
      .addCase(abilityActions.removeAbility, (state, { payload }) => {
        ...
        cardsAdapter.updateOne(state, {
          id: payload.enemyId,
          changes: { creaturesIds: newAbilitiesIds },
        });
      });
  },
});
